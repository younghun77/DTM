...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DTM_RADIO_IRQ_PRIORITY, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DTM_TIMER_IRQ_PRIORITY, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ANOMALY_172_TIMER_IRQ_PRIORITY, 2);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DTM_FAST_RAMP_UP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DTM_TRANSPORT_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DTM_TRANSPORT_LOG_LEVEL, 3);
