...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_CHOSEN|ncs,dtm-uart" "/soc/usbd@40027000/cdc_acm_uart0")
...
set_target_properties(${DEVICETREE_TARGET} PROPERTIES "DT_PROP|/soc/usbd@40027000/cdc_acm_uart0|current-speed" "19200")
